...
auto main(int argc, char** argv) -> int {
    ...
    try {
        ...
        fmt::print(stderr, "please make sure you provided ALL positional arguments.\n");
        fmt::print("{}\n", program.help().str());
    }

    catch (...) {
        fmt::print(stderr, "[ERROR]: unhandled exception, please make sure you provided ALL positional arguments.\n");
        fmt::print("{}\n", program.help().str());
    }
